...
const handlerWrapperArgs = { functionName: 'minanft-telegram-bot-dev-topup', timeout: 900 };

try {
  const userHandler = require('./mina.js');
  module.exports.handler = serverlessSDK.handler(userHandler.topup, handlerWrapperArgs);
} catch (error) {
