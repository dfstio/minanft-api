...
const handlerWrapperArgs = { functionName: 'minanft-telegram-bot-dev-deploy', timeout: 900 };

try {
  const userHandler = require('./mina.js');
  module.exports.handler = serverlessSDK.handler(userHandler.deploy, handlerWrapperArgs);
} catch (error) {
